...
function CheckAuthentication()
{
	...
	/**
	 * CUANDO SE MARCA CON TRUE, YA NO PERMITE EL ACCESO A LA PAGINA, MANDA DIRECTAMENTE AL BACKEND
	 */
	//return true;
	$activo=false;
	if(isset($_SESSION["usuarioBCKND"])){
		$activo=true;
	}
	return $activo;
}
...
*/
//$baseUrl = 'http://jadevu.hol.es/img/';
$baseUrl = 'http://jade-vu.com/web/img/';
