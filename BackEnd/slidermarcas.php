			...
			<div class="container">
				...
				<div class="col-md-12">
					...
					<div class="box" id="text-page">
						<h1>Slider de marcas</h1>

						<p class="lead">
							Aquí podrás agregar nuevas imágenes al slider marcas o editar las
							ya existentes.<br>Para editar una imagen del slider marcas de
							click en el icono <i class="fa fa-pencil fa-lg"></i>. <br>Para
